...
/**
 * Strings for component 'local_moodlemobileapp', language 'es_mx', version '4.0'.
 *
...
$string['core.ajaxendpointnotfound'] = '<p>AJAX endpoint no encontrado. Esto puede pasar si el sitio Moodle es muy antiguo o si bloquea el acceso a este endpoint. La App Moodle solamente soporta sistemas Moodle de {{$a}} en adelante. Por favor póngase en contacto con su administrador del sitio.</p>
<p>{{whoisadmin}}</p>';
...
$string['core.certificaterror'] = '<p>El certificado de este sitio no puede ser considerado como confiable por su dispositivo. Por favor póngase en contacto con su administrador del sitio.</p>
<p>{{whoisadmin}}</p>';
