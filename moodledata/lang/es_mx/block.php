...
/**
 * Strings for component 'block', language 'es_mx', version '4.0'.
 *
 * @package     block
 * @category    string
...
$string['createdat_help'] = 'La ubicación original donde fue creado el bloque. Las configuraciones del bloque pueden ocasionar que este bloque aparezca en otras ubicaciones (contextos) dentro de la ubicación original. Por ejemplo: un bloque creado dentro de una página de un curso podría ser mostrado en las actividades dentro de ese curso. Un bloque creado en la página inicial del sitio puede ser mostrado en todo el sitio.';
...
$string['showonfrontpageandsubs'] = 'Mostrar en la página inicial del sitio y en cualquier página agregada a la página inicial del sitio.';
$string['showonfrontpageonly'] = 'Mostrar sólo en la página inicial del sitio';
