...
/**
 * Strings for component 'hotquestion', language 'es_mx', version '4.0'.
 *
 * @package     hotquestion
 * @category    string
...
Esto es nominalmene un número de preguntas, pero el valor obtenido por un usuario puede ser mejorado por el factor de calor (las preguntas con más calor cuentan más) y por votar en otras preguntas (un usuario puede mejorar la calificación por participar al votar por preguntas de otros estudiantes.';
