...
/**
 * Strings for component 'role', language 'es_mx', version '4.0'.
 *
 * @package     role
 * @category    string
...
$string['archetypefrontpage'] = 'ARQUETIPO: Usuario autenticado en la página inicial del sitio';
...
$string['frontpageuser'] = 'Usuario autenticado en la página inicial del sitio';
$string['frontpageuserdescription'] = 'Todos los usuarios ingresados en el curso de la página inicial del sitio.';
$string['globalrole'] = 'Rol del sistema';
$string['globalroleswarning'] = '¡ADVERTENCIA! Cualquier rol que asigne desde esta página se aplicará a los usuarios asignados en todo el sitio, incluyendo la página inicial del sitio y todos los cursos.';
