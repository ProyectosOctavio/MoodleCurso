...
/**
 * Strings for component 'block_gps', language 'es_mx', version '4.0'.
 *
 * @package     block_gps
 * @category    string
...
$string['gps:addinstance'] = 'Añadir bloque de geolocalización';
$string['gps:myaddinstance'] = 'Añadir bloque de geolocalización';
$string['hints'] = 'Pistas';
...
$string['injectbanner:description'] = 'Este curso usa condiciones basadas en localización. Para ver estos recursos, usted necesita determinar su localización actual.';
...
$string['location_not_changed:title'] = 'Localización no cambiada';
