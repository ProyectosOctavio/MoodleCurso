...
/**
 * Strings for component 'feedback', language 'es_mx', version '4.0'.
 *
 * @package     feedback
 * @category    string
...
$string['configallowfullanonymous'] = 'Si se configura a \'Si\', los usuarios pueden completar una actividad de retroalimentación en la página inicial del sitio sin que se les pida  iniciar sesión.';
