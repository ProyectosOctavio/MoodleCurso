...
/**
 * Strings for component 'moodle', language 'es_mx', version '4.0'.
 *
 * @package     moodle
 * @category    string
...
$string['addfilehere'] = 'Soltar archivos aquí para añadirlos al fondo de esta sección';
...
$string['adminhelpsitesettings'] = 'Definir cómo se ve la página inicial del sitio';
...
La otra cookie es meramente por conveniencia, usualmente se llama MOODLEID o similar. Solamente recuerda su nombre_de_usuario en el navegador. Esto significa que cuando usted regresa a este sitio, el campo del nombre_de_usuario en la página para ingresar al sitio ya está llenado para usted. Es seguro el rechazar esta cookie - usted simplemente tendrá que re-escribir su nombre_de_usuario cada vez que inicie sesión .';
...
$string['frontpagedescription'] = 'Resumen de la página inicial del sitio';
$string['frontpagedescriptionhelp'] = 'Este resumen puede mostrarse en la página inicial del sitio usando el bloque de resumen del curso/sitio .';
$string['frontpageenrolledcourselist'] = 'Cursos inscritos';
$string['frontpageformat'] = 'Formato de la página inicial del sitio';
$string['frontpageformatloggedin'] = 'Formato de la página inicial del sitio cuando se ha iniciado sesión';
...
$string['hiddensections_help'] = 'Si es que las secciones ocultas son mostradas a estudiantes como no disponibles (tal vez para un curso en formato semanal para indicar vacaciones) o si están completamente ocultas.';
...
$string['restoretositeadding'] = 'Advertencia: ¡Está a punto de restaurar a la página inicial del sitio, añadiéndole datos!';
$string['restoretositedeleting'] = 'Advertencia: ¡Está a punto de restaurar a la página inicial del sitio, eliminando la información anterior!';
...
$string['showgrades_help'] = 'Muchas actividades permiten configurar calificaciones. Esta configuración determina si es que un estudiante puede o no ver una lista de todas sus calificaciones en el curso.';
...
$string['usernameemail'] = 'Nombre_de_usuario o Email';
