...
/**
 * Strings for component 'report_security', language 'es_mx', version '4.0'.
 *
...
$string['check_frontpagerole_details'] = '<p>El rol por defecto en la página inicial del sitio se da a todos los usuarios autenticados para las actividades en la página inicial del sito. Por favor, asegúrese de que no están permitidas capacidades riesgosas para este rol</p>
<p> Se recomienda crear un rol especial a tal efecto y no se use un tipo de rol preestablecido antiguo.</p>';
$string['check_frontpagerole_error'] = '¡Detectado un rol en la página inicial del sitio \'{$a}\' definido incorrectamente!';
$string['check_frontpagerole_name'] = 'Rol en la página inicial del sitio';
$string['check_frontpagerole_notset'] = 'El rol en la página inicial del sitio no está establecido.';
$string['check_frontpagerole_ok'] = 'La definición del rol en la página inicial del sitio es correcta.';
