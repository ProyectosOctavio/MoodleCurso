...
/**
 * Strings for component 'forum', language 'es_mx', version '4.0'.
 *
 * @package     forum
 * @category    string
...
$string['configlongpost'] = 'Cualquier mensaje que exceda esta extensión (en caracteres sin incluir código HTML) es considerada larga. Los mensajes mostrados en la página inicial del sitio, en las páginas de los cursos con formato social o en los perfiles de usuario, están recortados a una rotura natural en algún sitio entre los valores de forum_shortpost y forum_longpost.';
