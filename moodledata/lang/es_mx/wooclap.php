...
/**
 * Strings for component 'wooclap', language 'es_mx', version '4.0'.
 *
 * @package     wooclap
 * @category    string
...
$string['error-invalid-callback-url'] = 'La callback URL proporcionada no coincide con el nombre de baseurl domain definido en las configuraciones.';
