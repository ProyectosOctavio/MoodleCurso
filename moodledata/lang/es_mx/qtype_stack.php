...
/**
 * Strings for component 'qtype_stack', language 'es_mx', version '4.0'.
 *
 * @package     qtype_stack
 * @category    string
...
$string['castext_error_header'] = 'El renderizado del contenido de texto falló: esta pregunta está rota. Por favor póngase en contacto con su  profesor.';
...
$string['deployduplicateerror'] = 'Notas de pregunta duplicadas detectadas en las variables implementadas. Nosotros recomendamos encarecidamente que cada nota de pregunta solamente sea producida una vez; en caso contrario usted tendrá dificultades para recolectar estadísticas que tengan sentido cuando agrupe por variante. Por favor considere eliminar algunas variantes con notas duplicadas.';
...
$string['deployfromlist'] = 'Quitar todas las variantes existentes e implementar desde una lista de semillas de números enteros positivos, uno en cada línea:';
...
$string['editquestioninthequestionbank'] = 'Editar esta pregunta';
