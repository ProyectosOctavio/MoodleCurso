...
/**
 * Strings for component 'tool_uploadcourse', language 'es_mx', version '4.0'.
 *
...
$string['cannotupdatefrontpage'] = 'Usted no tiene permitido cambiar la página inicial del sitio.';
