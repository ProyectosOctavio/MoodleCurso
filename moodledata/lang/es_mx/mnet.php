...
/**
 * Strings for component 'mnet', language 'es_mx', version '4.0'.
 *
 * @package     mnet
 * @category    string
...
$string['mnetidproviderdesc'] = 'Usted puede emplear esta función para obtener un enlace con el que pueda entrar al sitio. Si puede proporcionar la dirección de correo electrónico correcta que coincida con el nombre_de_usuario con el cual Usted intentó  iniciar sesión previamente.';
