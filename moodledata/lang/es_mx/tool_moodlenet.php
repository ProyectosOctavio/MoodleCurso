...
/**
 * Strings for component 'tool_moodlenet', language 'es_mx', version '4.0'.
 *
...
$string['autoenablenotification'] = '<p>En Moodle 4.0 en adelante, la integración a  <a href="https://moodle.net/">MoodleNet</a> está habilitada de forma predeterminada en Características avanzadas. Los usuarios con la capacidad para crear y gestionar actividades pueden mirar MoodleNet vía el selector de actividades y pueden importar recursos de  MoodleNeta a sus cursos.</p><p>Si se deseara, puede especificarse una instancia alternativa de MoodleNet en <a href="{$a->settingslink}">Configuraciones de MoodleNet</a>.</p>';
