...
/**
 * Strings for component 'message', language 'es_mx', version '4.0'.
 *
 * @package     message
 * @category    string
...
$string['loggedin_help'] = 'Configurar el como le gustaría Usted recibir notificaciones cuando Usted haya iniciado sesión en Moodle';
...
$string['loggedoffdescription'] = 'Cuando Usted no está ingresado en Moodle';
