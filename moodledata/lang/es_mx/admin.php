...
/**
 * Strings for component 'admin', language 'es_mx', version '4.0'.
 *
 * @package     admin
 * @category    string
...
$string['configallowguestmymoodle'] = 'Si se habilita, los invitados podrán tener acceso al Tablero. De lo contrario los invitados son redireccionados a la página principal del sitio.';
...
$string['configfrontpage'] = 'Los elementos seleccionados arriba se mostrarán en la página inicial del sitio.';
$string['configfrontpagecourselimit'] = 'Número máximo de cursos';
$string['configfrontpagecourselimithelp'] = 'Número máximo de cursos a mostrarse en la página inicial del sitio en los listados de cursos.';
$string['configfrontpageloggedin'] = 'Los elementos seleccionados se mostrarán en la página inicial del sitio cuando un usuario haya iniciado sesión.';
...
$string['configintrosite'] = 'Esta página le permite configurar la página inicial del sitio y dar un nombre a su nuevo sitio. Puede volver aquí más adelante y cambiar estos ajustes en cualquier momento usando los menús de Administración.';
...
$string['configsupportpage'] = 'Un enlace a esta página será proporcionado para que los usuarios del sitio se pongan en contacto con el soporte del sitio. Si se deja en blanco, entonces en su lugar se proporcionará un enlace hacia el formato  de soporte.';
...
$string['frontpage'] = 'Página inicial del sitio';
$string['frontpagebackup'] = 'Respaldo de la página inicial del sitio';
$string['frontpagedefaultrole'] = 'Rol por defecto en la página inicial del sitio';
$string['frontpagefilters'] = 'Filtros de la página inicial del sitio';
$string['frontpageloggedin'] = 'Elementos de la página inicial del sitio al iniciar sesión';
$string['frontpageoverrides'] = 'Anulaciones de permisos en la página inicial del sitio';
$string['frontpagequestions'] = 'Preguntas de la página inicial del sitio';
$string['frontpagerestore'] = 'Restauración de la página inicial del sitio';
$string['frontpageroles'] = 'Roles de la página inicial del sitio';
$string['frontpagesettings'] = 'Configuraciones de la página inicial del sitio';
...
$string['navshowfrontpagemods'] = 'Mostrar las actividades de la página inicial del sitio en la navegación';
$string['navshowfrontpagemods_help'] = 'Si se habilita, las actividades de la página inicial del sitio se mostrarán en la navegación debajo de las páginas del sitio. Esta configuración solamente aplica en temas basados en Classic.';
...
$string['replacefrontsearch'] = 'Usado para búsqueda de curso en página inicial del sitio';
...
$string['sitesectionhelp'] = 'Si se selecciona, se mostrará una sección de tópico/tema en la página inicial del sitio del sitio.';
...
$string['testoutgoingmailconf_fromemail'] = 'Del nombre_de_usuario o la dirección Email';
...
$string['testoutgoingmailconf_fromemail_invalid'] = 'Nombre_de_usuario De o Email inválido. Debe ser un Email válido o un nombre_de_usuario existente en Moodle.';
...
$string['xmlrpcmnetauthenticationenabled'] = 'Se ha detectado que la autenticación de MNet está habilitado en su sitio. Esta característica depende de la extensión PHP XML-RPC, la cual ya no es mantenida por PHP.';
