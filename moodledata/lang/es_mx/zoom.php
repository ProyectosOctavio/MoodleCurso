...
/**
 * Strings for component 'zoom', language 'es_mx', version '4.0'.
 *
 * @package     zoom
 * @category    string
...
$string['meetingcapacitywarningcontactrealhost'] = 'Por favor acuda con el propietario de la cuenta ZOOM para obtener una licencia más grande si es que todos estos participantes del curso necesitan unirse a la reunión.';
