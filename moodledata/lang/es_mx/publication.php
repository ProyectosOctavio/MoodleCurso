...
/**
 * Strings for component 'publication', language 'es_mx', version '4.0'.
 *
 * @package     publication
 * @category    string
...
$string['studentapproval_help'] = 'La columna de estado representa la respuesta de los estudiantes a la aprobación:
