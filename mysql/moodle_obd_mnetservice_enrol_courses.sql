...
--
-- Table structure for table `obd_mnetservice_enrol_courses`
--

DROP TABLE IF EXISTS `obd_mnetservice_enrol_courses`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_mnetservice_enrol_courses` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `obd_mnetenrocour_hosrem_uix` (`hostid`,`remoteid`)
...
--
-- Dumping data for table `obd_mnetservice_enrol_courses`
--

LOCK TABLES `obd_mnetservice_enrol_courses` WRITE;
/*!40000 ALTER TABLE `obd_mnetservice_enrol_courses` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_mnetservice_enrol_courses` ENABLE KEYS */;
UNLOCK TABLES;
