...
--
-- Table structure for table `obd_mnet_session`
--

DROP TABLE IF EXISTS `obd_mnet_session`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_mnet_session` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `obd_mnetsess_tok_uix` (`token`)
...
--
-- Dumping data for table `obd_mnet_session`
--

LOCK TABLES `obd_mnet_session` WRITE;
/*!40000 ALTER TABLE `obd_mnet_session` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_mnet_session` ENABLE KEYS */;
UNLOCK TABLES;
