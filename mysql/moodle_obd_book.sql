...
--
-- Table structure for table `obd_book`
--

DROP TABLE IF EXISTS `obd_book`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_book` (
...
--
-- Dumping data for table `obd_book`
--

LOCK TABLES `obd_book` WRITE;
/*!40000 ALTER TABLE `obd_book` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_book` ENABLE KEYS */;
UNLOCK TABLES;
