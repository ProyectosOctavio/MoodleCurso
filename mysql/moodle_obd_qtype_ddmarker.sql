...
--
-- Table structure for table `obd_qtype_ddmarker`
--

DROP TABLE IF EXISTS `obd_qtype_ddmarker`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_qtype_ddmarker` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_qtypddma_que_ix` (`questionid`)
...
--
-- Dumping data for table `obd_qtype_ddmarker`
--

LOCK TABLES `obd_qtype_ddmarker` WRITE;
/*!40000 ALTER TABLE `obd_qtype_ddmarker` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_qtype_ddmarker` ENABLE KEYS */;
UNLOCK TABLES;
