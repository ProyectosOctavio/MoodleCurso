...
--
-- Table structure for table `obd_post`
--

DROP TABLE IF EXISTS `obd_post`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_post` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `obd_post_iduse_uix` (`id`,`userid`),
  KEY `obd_post_las_ix` (`lastmodified`),
  KEY `obd_post_mod_ix` (`module`),
  KEY `obd_post_sub_ix` (`subject`),
  KEY `obd_post_use_ix` (`usermodified`)
...
--
-- Dumping data for table `obd_post`
--

LOCK TABLES `obd_post` WRITE;
/*!40000 ALTER TABLE `obd_post` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_post` ENABLE KEYS */;
UNLOCK TABLES;
