...
--
-- Table structure for table `obd_notifications`
--

DROP TABLE IF EXISTS `obd_notifications`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_notifications` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_noti_use_ix` (`useridfrom`),
  KEY `obd_noti_use2_ix` (`useridto`)
...
--
-- Dumping data for table `obd_notifications`
--

LOCK TABLES `obd_notifications` WRITE;
/*!40000 ALTER TABLE `obd_notifications` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_notifications` ENABLE KEYS */;
UNLOCK TABLES;
