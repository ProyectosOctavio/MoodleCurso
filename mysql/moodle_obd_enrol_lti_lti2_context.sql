...
--
-- Table structure for table `obd_enrol_lti_lti2_context`
--

DROP TABLE IF EXISTS `obd_enrol_lti_lti2_context`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_enrol_lti_lti2_context` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_enroltilti2cont_con_ix` (`consumerid`)
...
--
-- Dumping data for table `obd_enrol_lti_lti2_context`
--

LOCK TABLES `obd_enrol_lti_lti2_context` WRITE;
/*!40000 ALTER TABLE `obd_enrol_lti_lti2_context` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_enrol_lti_lti2_context` ENABLE KEYS */;
UNLOCK TABLES;
