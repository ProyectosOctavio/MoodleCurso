...
--
-- Table structure for table `obd_data_content`
--

DROP TABLE IF EXISTS `obd_data_content`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_data_content` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_datacont_rec_ix` (`recordid`),
  KEY `obd_datacont_fie_ix` (`fieldid`)
...
--
-- Dumping data for table `obd_data_content`
--

LOCK TABLES `obd_data_content` WRITE;
/*!40000 ALTER TABLE `obd_data_content` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_data_content` ENABLE KEYS */;
UNLOCK TABLES;
