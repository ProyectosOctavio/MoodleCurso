...
--
-- Table structure for table `obd_workshopallocation_scheduled`
--

DROP TABLE IF EXISTS `obd_workshopallocation_scheduled`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_workshopallocation_scheduled` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `obd_worksche_wor_uix` (`workshopid`)
...
--
-- Dumping data for table `obd_workshopallocation_scheduled`
--

LOCK TABLES `obd_workshopallocation_scheduled` WRITE;
/*!40000 ALTER TABLE `obd_workshopallocation_scheduled` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_workshopallocation_scheduled` ENABLE KEYS */;
UNLOCK TABLES;
