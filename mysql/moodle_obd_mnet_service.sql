...
--
-- Table structure for table `obd_mnet_service`
--

DROP TABLE IF EXISTS `obd_mnet_service`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_mnet_service` (
...
--
-- Dumping data for table `obd_mnet_service`
--

LOCK TABLES `obd_mnet_service` WRITE;
/*!40000 ALTER TABLE `obd_mnet_service` DISABLE KEYS */;
INSERT INTO `obd_mnet_service` VALUES (1,'sso_idp','','1',1),(2,'sso_sp','','1',1),(3,'mnet_enrol','','1',1),(4,'pf','','1',1);
/*!40000 ALTER TABLE `obd_mnet_service` ENABLE KEYS */;
UNLOCK TABLES;
