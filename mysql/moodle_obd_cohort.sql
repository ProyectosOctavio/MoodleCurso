...
--
-- Table structure for table `obd_cohort`
--

DROP TABLE IF EXISTS `obd_cohort`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_cohort` (
...
--
-- Dumping data for table `obd_cohort`
--

LOCK TABLES `obd_cohort` WRITE;
/*!40000 ALTER TABLE `obd_cohort` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_cohort` ENABLE KEYS */;
UNLOCK TABLES;
