...
--
-- Table structure for table `obd_imscp`
--

DROP TABLE IF EXISTS `obd_imscp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_imscp` (
...
--
-- Dumping data for table `obd_imscp`
--

LOCK TABLES `obd_imscp` WRITE;
/*!40000 ALTER TABLE `obd_imscp` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_imscp` ENABLE KEYS */;
UNLOCK TABLES;
