...
--
-- Table structure for table `obd_comments`
--

DROP TABLE IF EXISTS `obd_comments`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_comments` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_comm_concomite_ix` (`contextid`,`commentarea`,`itemid`),
  KEY `obd_comm_use_ix` (`userid`)
...
--
-- Dumping data for table `obd_comments`
--

LOCK TABLES `obd_comments` WRITE;
/*!40000 ALTER TABLE `obd_comments` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_comments` ENABLE KEYS */;
UNLOCK TABLES;
