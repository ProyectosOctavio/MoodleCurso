...
--
-- Table structure for table `obd_messages`
--

DROP TABLE IF EXISTS `obd_messages`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_messages` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_mess_contim_ix` (`conversationid`,`timecreated`),
  KEY `obd_mess_use_ix` (`useridfrom`),
  KEY `obd_mess_con_ix` (`conversationid`)
...
--
-- Dumping data for table `obd_messages`
--

LOCK TABLES `obd_messages` WRITE;
/*!40000 ALTER TABLE `obd_messages` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_messages` ENABLE KEYS */;
UNLOCK TABLES;
