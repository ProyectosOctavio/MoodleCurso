...
--
-- Table structure for table `obd_user_devices`
--

DROP TABLE IF EXISTS `obd_user_devices`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_user_devices` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `obd_userdevi_pususe_uix` (`pushid`,`userid`),
  KEY `obd_userdevi_uuiuse_ix` (`uuid`,`userid`),
  KEY `obd_userdevi_use_ix` (`userid`)
...
--
-- Dumping data for table `obd_user_devices`
--

LOCK TABLES `obd_user_devices` WRITE;
/*!40000 ALTER TABLE `obd_user_devices` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_user_devices` ENABLE KEYS */;
UNLOCK TABLES;
