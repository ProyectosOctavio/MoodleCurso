...
--
-- Table structure for table `obd_tool_monitor_events`
--

DROP TABLE IF EXISTS `obd_tool_monitor_events`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_tool_monitor_events` (
...
--
-- Dumping data for table `obd_tool_monitor_events`
--

LOCK TABLES `obd_tool_monitor_events` WRITE;
/*!40000 ALTER TABLE `obd_tool_monitor_events` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_tool_monitor_events` ENABLE KEYS */;
UNLOCK TABLES;
