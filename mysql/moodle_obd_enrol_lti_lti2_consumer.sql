...
--
-- Table structure for table `obd_enrol_lti_lti2_consumer`
--

DROP TABLE IF EXISTS `obd_enrol_lti_lti2_consumer`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_enrol_lti_lti2_consumer` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `obd_enroltilti2cons_con_uix` (`consumerkey256`)
...
--
-- Dumping data for table `obd_enrol_lti_lti2_consumer`
--

LOCK TABLES `obd_enrol_lti_lti2_consumer` WRITE;
/*!40000 ALTER TABLE `obd_enrol_lti_lti2_consumer` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_enrol_lti_lti2_consumer` ENABLE KEYS */;
UNLOCK TABLES;
