...
--
-- Table structure for table `obd_wiki_locks`
--

DROP TABLE IF EXISTS `obd_wiki_locks`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_wiki_locks` (
...
--
-- Dumping data for table `obd_wiki_locks`
--

LOCK TABLES `obd_wiki_locks` WRITE;
/*!40000 ALTER TABLE `obd_wiki_locks` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_wiki_locks` ENABLE KEYS */;
UNLOCK TABLES;
