...
--
-- Table structure for table `obd_resource_old`
--

DROP TABLE IF EXISTS `obd_resource_old`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_resource_old` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `obd_resoold_old_uix` (`oldid`),
  KEY `obd_resoold_cmi_ix` (`cmid`)
...
--
-- Dumping data for table `obd_resource_old`
--

LOCK TABLES `obd_resource_old` WRITE;
/*!40000 ALTER TABLE `obd_resource_old` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_resource_old` ENABLE KEYS */;
UNLOCK TABLES;
