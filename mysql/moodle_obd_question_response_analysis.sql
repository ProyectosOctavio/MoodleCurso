...
--
-- Table structure for table `obd_question_response_analysis`
--

DROP TABLE IF EXISTS `obd_question_response_analysis`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_question_response_analysis` (
...
--
-- Dumping data for table `obd_question_response_analysis`
--

LOCK TABLES `obd_question_response_analysis` WRITE;
/*!40000 ALTER TABLE `obd_question_response_analysis` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_question_response_analysis` ENABLE KEYS */;
UNLOCK TABLES;
