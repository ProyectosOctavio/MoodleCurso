...
--
-- Table structure for table `obd_badge_endorsement`
--

DROP TABLE IF EXISTS `obd_badge_endorsement`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_badge_endorsement` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_badgendo_bad_ix` (`badgeid`)
...
--
-- Dumping data for table `obd_badge_endorsement`
--

LOCK TABLES `obd_badge_endorsement` WRITE;
/*!40000 ALTER TABLE `obd_badge_endorsement` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_badge_endorsement` ENABLE KEYS */;
UNLOCK TABLES;
