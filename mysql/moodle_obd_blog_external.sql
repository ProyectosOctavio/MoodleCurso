...
--
-- Table structure for table `obd_blog_external`
--

DROP TABLE IF EXISTS `obd_blog_external`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_blog_external` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_blogexte_use_ix` (`userid`)
...
--
-- Dumping data for table `obd_blog_external`
--

LOCK TABLES `obd_blog_external` WRITE;
/*!40000 ALTER TABLE `obd_blog_external` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_blog_external` ENABLE KEYS */;
UNLOCK TABLES;
