...
--
-- Table structure for table `obd_oauth2_issuer`
--

DROP TABLE IF EXISTS `obd_oauth2_issuer`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_oauth2_issuer` (
...
--
-- Dumping data for table `obd_oauth2_issuer`
--

LOCK TABLES `obd_oauth2_issuer` WRITE;
/*!40000 ALTER TABLE `obd_oauth2_issuer` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_oauth2_issuer` ENABLE KEYS */;
UNLOCK TABLES;
