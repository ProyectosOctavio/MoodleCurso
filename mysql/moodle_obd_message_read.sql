...
--
-- Table structure for table `obd_message_read`
--

DROP TABLE IF EXISTS `obd_message_read`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_message_read` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_messread_useusetimtim_ix` (`useridfrom`,`useridto`,`timeuserfromdeleted`,`timeusertodeleted`),
  KEY `obd_messread_nottim_ix` (`notification`,`timeread`),
  KEY `obd_messread_usetimnot_ix` (`useridfrom`,`timeuserfromdeleted`,`notification`),
  KEY `obd_messread_usetimnot2_ix` (`useridto`,`timeusertodeleted`,`notification`)
...
--
-- Dumping data for table `obd_message_read`
--

LOCK TABLES `obd_message_read` WRITE;
/*!40000 ALTER TABLE `obd_message_read` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_message_read` ENABLE KEYS */;
UNLOCK TABLES;
