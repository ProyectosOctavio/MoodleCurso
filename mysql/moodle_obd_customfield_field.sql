...
--
-- Table structure for table `obd_customfield_field`
--

DROP TABLE IF EXISTS `obd_customfield_field`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_customfield_field` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_custfiel_catsor_ix` (`categoryid`,`sortorder`),
  KEY `obd_custfiel_cat_ix` (`categoryid`)
...
--
-- Dumping data for table `obd_customfield_field`
--

LOCK TABLES `obd_customfield_field` WRITE;
/*!40000 ALTER TABLE `obd_customfield_field` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_customfield_field` ENABLE KEYS */;
UNLOCK TABLES;
