...
--
-- Table structure for table `obd_mnet_remote_rpc`
--

DROP TABLE IF EXISTS `obd_mnet_remote_rpc`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_mnet_remote_rpc` (
