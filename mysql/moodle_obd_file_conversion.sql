...
--
-- Table structure for table `obd_file_conversion`
--

DROP TABLE IF EXISTS `obd_file_conversion`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_file_conversion` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_fileconv_sou_ix` (`sourcefileid`),
  KEY `obd_fileconv_des_ix` (`destfileid`)
...
--
-- Dumping data for table `obd_file_conversion`
--

LOCK TABLES `obd_file_conversion` WRITE;
/*!40000 ALTER TABLE `obd_file_conversion` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_file_conversion` ENABLE KEYS */;
UNLOCK TABLES;
