...
--
-- Table structure for table `obd_qtype_ddmarker_drops`
--

DROP TABLE IF EXISTS `obd_qtype_ddmarker_drops`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_qtype_ddmarker_drops` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_qtypddmadrop_que_ix` (`questionid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=COMPRESSED COMMENT='drop regions';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `obd_qtype_ddmarker_drops`
--

LOCK TABLES `obd_qtype_ddmarker_drops` WRITE;
/*!40000 ALTER TABLE `obd_qtype_ddmarker_drops` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_qtype_ddmarker_drops` ENABLE KEYS */;
UNLOCK TABLES;
