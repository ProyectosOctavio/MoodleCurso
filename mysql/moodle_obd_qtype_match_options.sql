...
--
-- Table structure for table `obd_qtype_match_options`
--

DROP TABLE IF EXISTS `obd_qtype_match_options`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_qtype_match_options` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `obd_qtypmatcopti_que_uix` (`questionid`)
...
--
-- Dumping data for table `obd_qtype_match_options`
--

LOCK TABLES `obd_qtype_match_options` WRITE;
/*!40000 ALTER TABLE `obd_qtype_match_options` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_qtype_match_options` ENABLE KEYS */;
UNLOCK TABLES;
