...
--
-- Table structure for table `obd_analytics_models_log`
--

DROP TABLE IF EXISTS `obd_analytics_models_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_analytics_models_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_analmodelog_mod_ix` (`modelid`)
...
--
-- Dumping data for table `obd_analytics_models_log`
--

LOCK TABLES `obd_analytics_models_log` WRITE;
/*!40000 ALTER TABLE `obd_analytics_models_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_analytics_models_log` ENABLE KEYS */;
UNLOCK TABLES;
