...
--
-- Table structure for table `obd_backup_courses`
--

DROP TABLE IF EXISTS `obd_backup_courses`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_backup_courses` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `obd_backcour_cou_uix` (`courseid`)
...
--
-- Dumping data for table `obd_backup_courses`
--

LOCK TABLES `obd_backup_courses` WRITE;
/*!40000 ALTER TABLE `obd_backup_courses` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_backup_courses` ENABLE KEYS */;
UNLOCK TABLES;
