...
--
-- Table structure for table `obd_tool_dataprivacy_purpose`
--

DROP TABLE IF EXISTS `obd_tool_dataprivacy_purpose`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_tool_dataprivacy_purpose` (
...
--
-- Dumping data for table `obd_tool_dataprivacy_purpose`
--

LOCK TABLES `obd_tool_dataprivacy_purpose` WRITE;
/*!40000 ALTER TABLE `obd_tool_dataprivacy_purpose` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_tool_dataprivacy_purpose` ENABLE KEYS */;
UNLOCK TABLES;
