...
--
-- Table structure for table `obd_backup_controllers`
--

DROP TABLE IF EXISTS `obd_backup_controllers`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_backup_controllers` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `obd_backcont_bac_uix` (`backupid`),
  KEY `obd_backcont_typite_ix` (`type`,`itemid`),
  KEY `obd_backcont_useite_ix` (`userid`,`itemid`),
  KEY `obd_backcont_use_ix` (`userid`)
...
--
-- Dumping data for table `obd_backup_controllers`
--

LOCK TABLES `obd_backup_controllers` WRITE;
/*!40000 ALTER TABLE `obd_backup_controllers` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_backup_controllers` ENABLE KEYS */;
UNLOCK TABLES;
