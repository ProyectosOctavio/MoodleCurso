...
--
-- Table structure for table `obd_question_gapselect`
--

DROP TABLE IF EXISTS `obd_question_gapselect`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_question_gapselect` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_quesgaps_que_ix` (`questionid`)
...
--
-- Dumping data for table `obd_question_gapselect`
--

LOCK TABLES `obd_question_gapselect` WRITE;
/*!40000 ALTER TABLE `obd_question_gapselect` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_question_gapselect` ENABLE KEYS */;
UNLOCK TABLES;
