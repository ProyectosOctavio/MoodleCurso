...
--
-- Table structure for table `obd_scale_history`
--

DROP TABLE IF EXISTS `obd_scale_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_scale_history` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_scalhist_act_ix` (`action`),
  KEY `obd_scalhist_tim_ix` (`timemodified`),
  KEY `obd_scalhist_old_ix` (`oldid`),
  KEY `obd_scalhist_cou_ix` (`courseid`),
  KEY `obd_scalhist_log_ix` (`loggeduser`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=COMPRESSED COMMENT='History table';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `obd_scale_history`
--

LOCK TABLES `obd_scale_history` WRITE;
/*!40000 ALTER TABLE `obd_scale_history` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_scale_history` ENABLE KEYS */;
UNLOCK TABLES;
