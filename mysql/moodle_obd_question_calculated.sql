...
--
-- Table structure for table `obd_question_calculated`
--

DROP TABLE IF EXISTS `obd_question_calculated`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_question_calculated` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_quescalc_ans_ix` (`answer`),
  KEY `obd_quescalc_que_ix` (`question`)
...
--
-- Dumping data for table `obd_question_calculated`
--

LOCK TABLES `obd_question_calculated` WRITE;
/*!40000 ALTER TABLE `obd_question_calculated` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_question_calculated` ENABLE KEYS */;
UNLOCK TABLES;
