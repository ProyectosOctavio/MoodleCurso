...
--
-- Table structure for table `obd_stats_daily`
--

DROP TABLE IF EXISTS `obd_stats_daily`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_stats_daily` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_statdail_cou_ix` (`courseid`),
  KEY `obd_statdail_tim_ix` (`timeend`),
  KEY `obd_statdail_rol_ix` (`roleid`)
...
--
-- Dumping data for table `obd_stats_daily`
--

LOCK TABLES `obd_stats_daily` WRITE;
/*!40000 ALTER TABLE `obd_stats_daily` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_stats_daily` ENABLE KEYS */;
UNLOCK TABLES;
