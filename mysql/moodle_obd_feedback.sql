...
--
-- Table structure for table `obd_feedback`
--

DROP TABLE IF EXISTS `obd_feedback`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_feedback` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_feed_cou_ix` (`course`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=COMPRESSED COMMENT='all feedbacks';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `obd_feedback`
--

LOCK TABLES `obd_feedback` WRITE;
/*!40000 ALTER TABLE `obd_feedback` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_feedback` ENABLE KEYS */;
UNLOCK TABLES;
