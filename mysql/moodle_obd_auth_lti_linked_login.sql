...
--
-- Table structure for table `obd_auth_lti_linked_login`
--

DROP TABLE IF EXISTS `obd_auth_lti_linked_login`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_auth_lti_linked_login` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `obd_authltilinklogi_useiss_uix` (`userid`,`issuer256`,`sub256`),
  KEY `obd_authltilinklogi_use_ix` (`userid`)
...
--
-- Dumping data for table `obd_auth_lti_linked_login`
--

LOCK TABLES `obd_auth_lti_linked_login` WRITE;
/*!40000 ALTER TABLE `obd_auth_lti_linked_login` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_auth_lti_linked_login` ENABLE KEYS */;
UNLOCK TABLES;
