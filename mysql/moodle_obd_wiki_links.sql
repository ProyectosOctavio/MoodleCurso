...
--
-- Table structure for table `obd_wiki_links`
--

DROP TABLE IF EXISTS `obd_wiki_links`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_wiki_links` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_wikilink_fro_ix` (`frompageid`),
  KEY `obd_wikilink_sub_ix` (`subwikiid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=COMPRESSED COMMENT='Page wiki links';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `obd_wiki_links`
--

LOCK TABLES `obd_wiki_links` WRITE;
/*!40000 ALTER TABLE `obd_wiki_links` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_wiki_links` ENABLE KEYS */;
UNLOCK TABLES;
