...
--
-- Table structure for table `obd_portfolio_log`
--

DROP TABLE IF EXISTS `obd_portfolio_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_portfolio_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_portlog_use_ix` (`userid`),
  KEY `obd_portlog_por_ix` (`portfolio`)
...
--
-- Dumping data for table `obd_portfolio_log`
--

LOCK TABLES `obd_portfolio_log` WRITE;
/*!40000 ALTER TABLE `obd_portfolio_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_portfolio_log` ENABLE KEYS */;
UNLOCK TABLES;
