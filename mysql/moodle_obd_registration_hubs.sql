...
--
-- Table structure for table `obd_registration_hubs`
--

DROP TABLE IF EXISTS `obd_registration_hubs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_registration_hubs` (
...
--
-- Dumping data for table `obd_registration_hubs`
--

LOCK TABLES `obd_registration_hubs` WRITE;
/*!40000 ALTER TABLE `obd_registration_hubs` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_registration_hubs` ENABLE KEYS */;
UNLOCK TABLES;
