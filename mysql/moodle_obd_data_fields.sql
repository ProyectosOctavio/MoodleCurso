...
--
-- Table structure for table `obd_data_fields`
--

DROP TABLE IF EXISTS `obd_data_fields`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_data_fields` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_datafiel_typdat_ix` (`type`,`dataid`),
  KEY `obd_datafiel_dat_ix` (`dataid`)
...
--
-- Dumping data for table `obd_data_fields`
--

LOCK TABLES `obd_data_fields` WRITE;
/*!40000 ALTER TABLE `obd_data_fields` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_data_fields` ENABLE KEYS */;
UNLOCK TABLES;
