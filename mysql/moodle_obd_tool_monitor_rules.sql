...
--
-- Table structure for table `obd_tool_monitor_rules`
--

DROP TABLE IF EXISTS `obd_tool_monitor_rules`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_tool_monitor_rules` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_toolmonirule_couuse_ix` (`courseid`,`userid`),
  KEY `obd_toolmonirule_eve_ix` (`eventname`)
...
--
-- Dumping data for table `obd_tool_monitor_rules`
--

LOCK TABLES `obd_tool_monitor_rules` WRITE;
/*!40000 ALTER TABLE `obd_tool_monitor_rules` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_tool_monitor_rules` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-10-11 19:38:21
