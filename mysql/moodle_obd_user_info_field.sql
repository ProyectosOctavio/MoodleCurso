...
--
-- Table structure for table `obd_user_info_field`
--

DROP TABLE IF EXISTS `obd_user_info_field`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_user_info_field` (
...
--
-- Dumping data for table `obd_user_info_field`
--

LOCK TABLES `obd_user_info_field` WRITE;
/*!40000 ALTER TABLE `obd_user_info_field` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_user_info_field` ENABLE KEYS */;
UNLOCK TABLES;
