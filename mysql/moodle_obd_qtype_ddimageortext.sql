...
--
-- Table structure for table `obd_qtype_ddimageortext`
--

DROP TABLE IF EXISTS `obd_qtype_ddimageortext`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_qtype_ddimageortext` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_qtypddim_que_ix` (`questionid`)
...
--
-- Dumping data for table `obd_qtype_ddimageortext`
--

LOCK TABLES `obd_qtype_ddimageortext` WRITE;
/*!40000 ALTER TABLE `obd_qtype_ddimageortext` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_qtype_ddimageortext` ENABLE KEYS */;
UNLOCK TABLES;
