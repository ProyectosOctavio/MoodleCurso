...
--
-- Table structure for table `obd_event_subscriptions`
--

DROP TABLE IF EXISTS `obd_event_subscriptions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_event_subscriptions` (
...
--
-- Dumping data for table `obd_event_subscriptions`
--

LOCK TABLES `obd_event_subscriptions` WRITE;
/*!40000 ALTER TABLE `obd_event_subscriptions` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_event_subscriptions` ENABLE KEYS */;
UNLOCK TABLES;
