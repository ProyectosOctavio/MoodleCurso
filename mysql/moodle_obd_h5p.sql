...
--
-- Table structure for table `obd_h5p`
--

DROP TABLE IF EXISTS `obd_h5p`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_h5p` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_h5p_mai_ix` (`mainlibraryid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=COMPRESSED COMMENT='Stores H5P content information';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `obd_h5p`
--

LOCK TABLES `obd_h5p` WRITE;
/*!40000 ALTER TABLE `obd_h5p` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_h5p` ENABLE KEYS */;
UNLOCK TABLES;
