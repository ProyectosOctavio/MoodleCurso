...
--
-- Table structure for table `obd_assignfeedback_editpdf_annot`
--

DROP TABLE IF EXISTS `obd_assignfeedback_editpdf_annot`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_assignfeedback_editpdf_annot` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_assieditanno_grapag_ix` (`gradeid`,`pageno`),
  KEY `obd_assieditanno_gra_ix` (`gradeid`)
...
--
-- Dumping data for table `obd_assignfeedback_editpdf_annot`
--

LOCK TABLES `obd_assignfeedback_editpdf_annot` WRITE;
/*!40000 ALTER TABLE `obd_assignfeedback_editpdf_annot` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_assignfeedback_editpdf_annot` ENABLE KEYS */;
UNLOCK TABLES;
