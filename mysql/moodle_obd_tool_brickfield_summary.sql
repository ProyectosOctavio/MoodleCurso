...
--
-- Table structure for table `obd_tool_brickfield_summary`
--

DROP TABLE IF EXISTS `obd_tool_brickfield_summary`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_tool_brickfield_summary` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_toolbricsumm_sta_ix` (`status`),
  KEY `obd_toolbricsumm_cou_ix` (`courseid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=COMPRESSED COMMENT='Contains accessibility check results summary information.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `obd_tool_brickfield_summary`
--

LOCK TABLES `obd_tool_brickfield_summary` WRITE;
/*!40000 ALTER TABLE `obd_tool_brickfield_summary` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_tool_brickfield_summary` ENABLE KEYS */;
UNLOCK TABLES;
