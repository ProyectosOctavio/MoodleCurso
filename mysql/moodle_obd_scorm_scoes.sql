...
--
-- Table structure for table `obd_scorm_scoes`
--

DROP TABLE IF EXISTS `obd_scorm_scoes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_scorm_scoes` (
...
--
-- Dumping data for table `obd_scorm_scoes`
--

LOCK TABLES `obd_scorm_scoes` WRITE;
/*!40000 ALTER TABLE `obd_scorm_scoes` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_scorm_scoes` ENABLE KEYS */;
UNLOCK TABLES;
