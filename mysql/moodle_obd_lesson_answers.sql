...
--
-- Table structure for table `obd_lesson_answers`
--

DROP TABLE IF EXISTS `obd_lesson_answers`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_lesson_answers` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_lessansw_les_ix` (`lessonid`),
  KEY `obd_lessansw_pag_ix` (`pageid`)
...
--
-- Dumping data for table `obd_lesson_answers`
--

LOCK TABLES `obd_lesson_answers` WRITE;
/*!40000 ALTER TABLE `obd_lesson_answers` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_lesson_answers` ENABLE KEYS */;
UNLOCK TABLES;
