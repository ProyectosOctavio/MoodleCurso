...
--
-- Table structure for table `obd_feedback_item`
--

DROP TABLE IF EXISTS `obd_feedback_item`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_feedback_item` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_feeditem_fee_ix` (`feedback`),
  KEY `obd_feeditem_tem_ix` (`template`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=COMPRESSED COMMENT='feedback_items';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `obd_feedback_item`
--

LOCK TABLES `obd_feedback_item` WRITE;
/*!40000 ALTER TABLE `obd_feedback_item` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_feedback_item` ENABLE KEYS */;
UNLOCK TABLES;
