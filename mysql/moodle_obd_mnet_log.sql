...
--
-- Table structure for table `obd_mnet_log`
--

DROP TABLE IF EXISTS `obd_mnet_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_mnet_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_mnetlog_hosusecou_ix` (`hostid`,`userid`,`course`)
...
--
-- Dumping data for table `obd_mnet_log`
--

LOCK TABLES `obd_mnet_log` WRITE;
/*!40000 ALTER TABLE `obd_mnet_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_mnet_log` ENABLE KEYS */;
UNLOCK TABLES;
