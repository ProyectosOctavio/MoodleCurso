...
--
-- Table structure for table `obd_qtype_match_subquestions`
--

DROP TABLE IF EXISTS `obd_qtype_match_subquestions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_qtype_match_subquestions` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_qtypmatcsubq_que_ix` (`questionid`)
...
--
-- Dumping data for table `obd_qtype_match_subquestions`
--

LOCK TABLES `obd_qtype_match_subquestions` WRITE;
/*!40000 ALTER TABLE `obd_qtype_match_subquestions` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_qtype_match_subquestions` ENABLE KEYS */;
UNLOCK TABLES;
