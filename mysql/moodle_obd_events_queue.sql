...
--
-- Table structure for table `obd_events_queue`
--

DROP TABLE IF EXISTS `obd_events_queue`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_events_queue` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_evenqueu_use_ix` (`userid`)
...
--
-- Dumping data for table `obd_events_queue`
--

LOCK TABLES `obd_events_queue` WRITE;
/*!40000 ALTER TABLE `obd_events_queue` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_events_queue` ENABLE KEYS */;
UNLOCK TABLES;
