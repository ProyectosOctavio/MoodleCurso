...
--
-- Table structure for table `obd_gradingform_guide_criteria`
--

DROP TABLE IF EXISTS `obd_gradingform_guide_criteria`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_gradingform_guide_criteria` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_gradguidcrit_def_ix` (`definitionid`)
...
--
-- Dumping data for table `obd_gradingform_guide_criteria`
--

LOCK TABLES `obd_gradingform_guide_criteria` WRITE;
/*!40000 ALTER TABLE `obd_gradingform_guide_criteria` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_gradingform_guide_criteria` ENABLE KEYS */;
UNLOCK TABLES;
