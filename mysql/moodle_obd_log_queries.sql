...
--
-- Table structure for table `obd_log_queries`
--

DROP TABLE IF EXISTS `obd_log_queries`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_log_queries` (
...
--
-- Dumping data for table `obd_log_queries`
--

LOCK TABLES `obd_log_queries` WRITE;
/*!40000 ALTER TABLE `obd_log_queries` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_log_queries` ENABLE KEYS */;
UNLOCK TABLES;
