...
--
-- Table structure for table `obd_competency_template`
--

DROP TABLE IF EXISTS `obd_competency_template`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_competency_template` (
...
--
-- Dumping data for table `obd_competency_template`
--

LOCK TABLES `obd_competency_template` WRITE;
/*!40000 ALTER TABLE `obd_competency_template` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_competency_template` ENABLE KEYS */;
UNLOCK TABLES;
