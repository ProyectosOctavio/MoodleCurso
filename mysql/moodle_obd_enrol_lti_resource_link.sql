...
--
-- Table structure for table `obd_enrol_lti_resource_link`
--

DROP TABLE IF EXISTS `obd_enrol_lti_resource_link`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_enrol_lti_resource_link` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `obd_enroltiresolink_reslti_uix` (`resourcelinkid`,`ltideploymentid`),
  KEY `obd_enroltiresolink_lti_ix` (`ltideploymentid`),
  KEY `obd_enroltiresolink_lti2_ix` (`lticontextid`)
...
--
-- Dumping data for table `obd_enrol_lti_resource_link`
--

LOCK TABLES `obd_enrol_lti_resource_link` WRITE;
/*!40000 ALTER TABLE `obd_enrol_lti_resource_link` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_enrol_lti_resource_link` ENABLE KEYS */;
UNLOCK TABLES;
