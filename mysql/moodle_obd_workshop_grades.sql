...
--
-- Table structure for table `obd_workshop_grades`
--

DROP TABLE IF EXISTS `obd_workshop_grades`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_workshop_grades` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `obd_workgrad_assstrdim_uix` (`assessmentid`,`strategy`,`dimensionid`),
  KEY `obd_workgrad_ass_ix` (`assessmentid`)
...
--
-- Dumping data for table `obd_workshop_grades`
--

LOCK TABLES `obd_workshop_grades` WRITE;
/*!40000 ALTER TABLE `obd_workshop_grades` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_workshop_grades` ENABLE KEYS */;
UNLOCK TABLES;
