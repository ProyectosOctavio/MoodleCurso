...
--
-- Table structure for table `obd_groupings`
--

DROP TABLE IF EXISTS `obd_groupings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_groupings` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_grou_idn2_ix` (`idnumber`),
  KEY `obd_grou_cou2_ix` (`courseid`)
...
--
-- Dumping data for table `obd_groupings`
--

LOCK TABLES `obd_groupings` WRITE;
/*!40000 ALTER TABLE `obd_groupings` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_groupings` ENABLE KEYS */;
UNLOCK TABLES;
