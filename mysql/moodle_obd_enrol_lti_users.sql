...
--
-- Table structure for table `obd_enrol_lti_users`
--

DROP TABLE IF EXISTS `obd_enrol_lti_users`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_enrol_lti_users` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_enroltiuser_use_ix` (`userid`),
  KEY `obd_enroltiuser_too_ix` (`toolid`),
  KEY `obd_enroltiuser_lti_ix` (`ltideploymentid`)
...
--
-- Dumping data for table `obd_enrol_lti_users`
--

LOCK TABLES `obd_enrol_lti_users` WRITE;
/*!40000 ALTER TABLE `obd_enrol_lti_users` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_enrol_lti_users` ENABLE KEYS */;
UNLOCK TABLES;
