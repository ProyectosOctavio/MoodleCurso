...
--
-- Table structure for table `obd_adminpresets_plug`
--

DROP TABLE IF EXISTS `obd_adminpresets_plug`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_adminpresets_plug` (
...
-- Dump completed on 2022-10-11 19:39:02
