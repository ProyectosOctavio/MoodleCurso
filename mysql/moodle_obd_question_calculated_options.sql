...
--
-- Table structure for table `obd_question_calculated_options`
--

DROP TABLE IF EXISTS `obd_question_calculated_options`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_question_calculated_options` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_quescalcopti_que_ix` (`question`)
...
--
-- Dumping data for table `obd_question_calculated_options`
--

LOCK TABLES `obd_question_calculated_options` WRITE;
/*!40000 ALTER TABLE `obd_question_calculated_options` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_question_calculated_options` ENABLE KEYS */;
UNLOCK TABLES;
