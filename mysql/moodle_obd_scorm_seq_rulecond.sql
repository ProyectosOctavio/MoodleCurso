...
--
-- Table structure for table `obd_scorm_seq_rulecond`
--

DROP TABLE IF EXISTS `obd_scorm_seq_rulecond`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_scorm_seq_rulecond` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `obd_scorseqrule_idscorul_uix` (`id`,`scoid`,`ruleconditionsid`),
  KEY `obd_scorseqrule_sco2_ix` (`scoid`),
  KEY `obd_scorseqrule_rul_ix` (`ruleconditionsid`)
...
--
-- Dumping data for table `obd_scorm_seq_rulecond`
--

LOCK TABLES `obd_scorm_seq_rulecond` WRITE;
/*!40000 ALTER TABLE `obd_scorm_seq_rulecond` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_scorm_seq_rulecond` ENABLE KEYS */;
UNLOCK TABLES;
