...
--
-- Table structure for table `obd_quiz_statistics`
--

DROP TABLE IF EXISTS `obd_quiz_statistics`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_quiz_statistics` (
...
--
-- Dumping data for table `obd_quiz_statistics`
--

LOCK TABLES `obd_quiz_statistics` WRITE;
/*!40000 ALTER TABLE `obd_quiz_statistics` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_quiz_statistics` ENABLE KEYS */;
UNLOCK TABLES;
