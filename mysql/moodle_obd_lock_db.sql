...
--
-- Table structure for table `obd_lock_db`
--

DROP TABLE IF EXISTS `obd_lock_db`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_lock_db` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `obd_lockdb_res_uix` (`resourcekey`),
  KEY `obd_lockdb_exp_ix` (`expires`),
  KEY `obd_lockdb_own_ix` (`owner`)
...
--
-- Dumping data for table `obd_lock_db`
--

LOCK TABLES `obd_lock_db` WRITE;
/*!40000 ALTER TABLE `obd_lock_db` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_lock_db` ENABLE KEYS */;
UNLOCK TABLES;
