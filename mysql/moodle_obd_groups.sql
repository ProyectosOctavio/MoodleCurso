...
--
-- Table structure for table `obd_groups`
--

DROP TABLE IF EXISTS `obd_groups`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_groups` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_grou_idn_ix` (`idnumber`),
  KEY `obd_grou_cou_ix` (`courseid`)
...
--
-- Dumping data for table `obd_groups`
--

LOCK TABLES `obd_groups` WRITE;
/*!40000 ALTER TABLE `obd_groups` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_groups` ENABLE KEYS */;
UNLOCK TABLES;
