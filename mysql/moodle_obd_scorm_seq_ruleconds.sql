...
--
-- Table structure for table `obd_scorm_seq_ruleconds`
--

DROP TABLE IF EXISTS `obd_scorm_seq_ruleconds`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_scorm_seq_ruleconds` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `obd_scorseqrule_scoid_uix` (`scoid`,`id`),
  KEY `obd_scorseqrule_sco_ix` (`scoid`)
...
--
-- Dumping data for table `obd_scorm_seq_ruleconds`
--

LOCK TABLES `obd_scorm_seq_ruleconds` WRITE;
/*!40000 ALTER TABLE `obd_scorm_seq_ruleconds` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_scorm_seq_ruleconds` ENABLE KEYS */;
UNLOCK TABLES;
