...
--
-- Table structure for table `obd_book_chapters`
--

DROP TABLE IF EXISTS `obd_book_chapters`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_book_chapters` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_bookchap_boo_ix` (`bookid`)
...
--
-- Dumping data for table `obd_book_chapters`
--

LOCK TABLES `obd_book_chapters` WRITE;
/*!40000 ALTER TABLE `obd_book_chapters` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_book_chapters` ENABLE KEYS */;
UNLOCK TABLES;
