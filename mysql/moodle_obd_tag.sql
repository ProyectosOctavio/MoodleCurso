...
--
-- Table structure for table `obd_tag`
--

DROP TABLE IF EXISTS `obd_tag`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_tag` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `obd_tag_tagnam_uix` (`tagcollid`,`name`),
  KEY `obd_tag_tagiss_ix` (`tagcollid`,`isstandard`),
  KEY `obd_tag_use_ix` (`userid`),
  KEY `obd_tag_tag_ix` (`tagcollid`)
...
--
-- Dumping data for table `obd_tag`
--

LOCK TABLES `obd_tag` WRITE;
/*!40000 ALTER TABLE `obd_tag` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_tag` ENABLE KEYS */;
UNLOCK TABLES;
