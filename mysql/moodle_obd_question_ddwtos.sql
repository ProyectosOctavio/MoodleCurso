...
--
-- Table structure for table `obd_question_ddwtos`
--

DROP TABLE IF EXISTS `obd_question_ddwtos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_question_ddwtos` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_quesddwt_que_ix` (`questionid`)
...
--
-- Dumping data for table `obd_question_ddwtos`
--

LOCK TABLES `obd_question_ddwtos` WRITE;
/*!40000 ALTER TABLE `obd_question_ddwtos` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_question_ddwtos` ENABLE KEYS */;
UNLOCK TABLES;
