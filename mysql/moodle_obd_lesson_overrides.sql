...
--
-- Table structure for table `obd_lesson_overrides`
--

DROP TABLE IF EXISTS `obd_lesson_overrides`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_lesson_overrides` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_lessover_les_ix` (`lessonid`),
  KEY `obd_lessover_gro_ix` (`groupid`),
  KEY `obd_lessover_use_ix` (`userid`)
...
--
-- Dumping data for table `obd_lesson_overrides`
--

LOCK TABLES `obd_lesson_overrides` WRITE;
/*!40000 ALTER TABLE `obd_lesson_overrides` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_lesson_overrides` ENABLE KEYS */;
UNLOCK TABLES;
