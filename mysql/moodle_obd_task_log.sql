...
--
-- Table structure for table `obd_task_log`
--

DROP TABLE IF EXISTS `obd_task_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_task_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_tasklog_cla_ix` (`classname`),
  KEY `obd_tasklog_tim_ix` (`timestart`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=COMPRESSED COMMENT='The log table for all tasks';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `obd_task_log`
--

LOCK TABLES `obd_task_log` WRITE;
/*!40000 ALTER TABLE `obd_task_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_task_log` ENABLE KEYS */;
UNLOCK TABLES;
