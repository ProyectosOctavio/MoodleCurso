...
--
-- Table structure for table `obd_tag_coll`
--

DROP TABLE IF EXISTS `obd_tag_coll`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_tag_coll` (
...
--
-- Dumping data for table `obd_tag_coll`
--

LOCK TABLES `obd_tag_coll` WRITE;
/*!40000 ALTER TABLE `obd_tag_coll` DISABLE KEYS */;
INSERT INTO `obd_tag_coll` VALUES (1,NULL,1,NULL,0,1,NULL);
/*!40000 ALTER TABLE `obd_tag_coll` ENABLE KEYS */;
UNLOCK TABLES;
