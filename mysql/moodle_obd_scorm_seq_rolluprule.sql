...
--
-- Table structure for table `obd_scorm_seq_rolluprule`
--

DROP TABLE IF EXISTS `obd_scorm_seq_rolluprule`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_scorm_seq_rolluprule` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `obd_scorseqroll_scoid_uix` (`scoid`,`id`),
  KEY `obd_scorseqroll_sco_ix` (`scoid`)
...
--
-- Dumping data for table `obd_scorm_seq_rolluprule`
--

LOCK TABLES `obd_scorm_seq_rolluprule` WRITE;
/*!40000 ALTER TABLE `obd_scorm_seq_rolluprule` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_scorm_seq_rolluprule` ENABLE KEYS */;
UNLOCK TABLES;
