...
--
-- Table structure for table `obd_chat_users`
--

DROP TABLE IF EXISTS `obd_chat_users`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_chat_users` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_chatuser_use_ix` (`userid`),
  KEY `obd_chatuser_las_ix` (`lastping`),
  KEY `obd_chatuser_gro_ix` (`groupid`),
  KEY `obd_chatuser_cha_ix` (`chatid`)
...
--
-- Dumping data for table `obd_chat_users`
--

LOCK TABLES `obd_chat_users` WRITE;
/*!40000 ALTER TABLE `obd_chat_users` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_chat_users` ENABLE KEYS */;
UNLOCK TABLES;
