...
--
-- Table structure for table `obd_chat`
--

DROP TABLE IF EXISTS `obd_chat`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_chat` (
...
--
-- Dumping data for table `obd_chat`
--

LOCK TABLES `obd_chat` WRITE;
/*!40000 ALTER TABLE `obd_chat` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_chat` ENABLE KEYS */;
UNLOCK TABLES;
