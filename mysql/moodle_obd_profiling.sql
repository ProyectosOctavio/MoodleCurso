...
--
-- Table structure for table `obd_profiling`
--

DROP TABLE IF EXISTS `obd_profiling`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_profiling` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `obd_prof_run_uix` (`runid`),
  KEY `obd_prof_urlrun_ix` (`url`,`runreference`),
  KEY `obd_prof_timrun_ix` (`timecreated`,`runreference`)
...
--
-- Dumping data for table `obd_profiling`
--

LOCK TABLES `obd_profiling` WRITE;
/*!40000 ALTER TABLE `obd_profiling` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_profiling` ENABLE KEYS */;
UNLOCK TABLES;
