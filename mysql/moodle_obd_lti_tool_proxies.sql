...
--
-- Table structure for table `obd_lti_tool_proxies`
--

DROP TABLE IF EXISTS `obd_lti_tool_proxies`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_lti_tool_proxies` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `obd_ltitoolprox_gui_uix` (`guid`)
...
--
-- Dumping data for table `obd_lti_tool_proxies`
--

LOCK TABLES `obd_lti_tool_proxies` WRITE;
/*!40000 ALTER TABLE `obd_lti_tool_proxies` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_lti_tool_proxies` ENABLE KEYS */;
UNLOCK TABLES;
