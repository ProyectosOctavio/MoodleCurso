...
--
-- Table structure for table `obd_glossary_formats`
--

DROP TABLE IF EXISTS `obd_glossary_formats`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_glossary_formats` (
...
--
-- Dumping data for table `obd_glossary_formats`
--

LOCK TABLES `obd_glossary_formats` WRITE;
/*!40000 ALTER TABLE `obd_glossary_formats` DISABLE KEYS */;
INSERT INTO `obd_glossary_formats` VALUES (1,'continuous','continuous',1,1,'standard,category,date','','','',''),(2,'dictionary','dictionary',1,1,'standard','','','',''),(3,'encyclopedia','encyclopedia',1,1,'standard,category,date,author','','','',''),(4,'entrylist','entrylist',1,1,'standard,category,date,author','','','',''),(5,'faq','faq',1,1,'standard,category,date,author','','','',''),(6,'fullwithauthor','fullwithauthor',1,1,'standard,category,date,author','','','',''),(7,'fullwithoutauthor','fullwithoutauthor',1,1,'standard,category,date','','','','');
/*!40000 ALTER TABLE `obd_glossary_formats` ENABLE KEYS */;
UNLOCK TABLES;
