...
--
-- Table structure for table `obd_glossary_entries`
--

DROP TABLE IF EXISTS `obd_glossary_entries`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_glossary_entries` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_glosentr_use_ix` (`userid`),
  KEY `obd_glosentr_con_ix` (`concept`),
  KEY `obd_glosentr_glo_ix` (`glossaryid`)
...
--
-- Dumping data for table `obd_glossary_entries`
--

LOCK TABLES `obd_glossary_entries` WRITE;
/*!40000 ALTER TABLE `obd_glossary_entries` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_glossary_entries` ENABLE KEYS */;
UNLOCK TABLES;
