...
--
-- Table structure for table `obd_workshop_submissions`
--

DROP TABLE IF EXISTS `obd_workshop_submissions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_workshop_submissions` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_worksubm_wor_ix` (`workshopid`),
  KEY `obd_worksubm_gra_ix` (`gradeoverby`),
  KEY `obd_worksubm_aut_ix` (`authorid`)
...
--
-- Dumping data for table `obd_workshop_submissions`
--

LOCK TABLES `obd_workshop_submissions` WRITE;
/*!40000 ALTER TABLE `obd_workshop_submissions` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_workshop_submissions` ENABLE KEYS */;
UNLOCK TABLES;
