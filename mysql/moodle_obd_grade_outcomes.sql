...
--
-- Table structure for table `obd_grade_outcomes`
--

DROP TABLE IF EXISTS `obd_grade_outcomes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_grade_outcomes` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `obd_gradoutc_cousho_uix` (`courseid`,`shortname`),
  KEY `obd_gradoutc_cou_ix` (`courseid`),
  KEY `obd_gradoutc_sca_ix` (`scaleid`),
  KEY `obd_gradoutc_use_ix` (`usermodified`)
...
--
-- Dumping data for table `obd_grade_outcomes`
--

LOCK TABLES `obd_grade_outcomes` WRITE;
/*!40000 ALTER TABLE `obd_grade_outcomes` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_grade_outcomes` ENABLE KEYS */;
UNLOCK TABLES;
