...
--
-- Table structure for table `obd_tool_policy_versions`
--

DROP TABLE IF EXISTS `obd_tool_policy_versions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_tool_policy_versions` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_toolpolivers_use_ix` (`usermodified`),
  KEY `obd_toolpolivers_pol_ix` (`policyid`)
...
--
-- Dumping data for table `obd_tool_policy_versions`
--

LOCK TABLES `obd_tool_policy_versions` WRITE;
/*!40000 ALTER TABLE `obd_tool_policy_versions` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_tool_policy_versions` ENABLE KEYS */;
UNLOCK TABLES;
