...
--
-- Table structure for table `obd_adminpresets_app_plug`
--

DROP TABLE IF EXISTS `obd_adminpresets_app_plug`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_adminpresets_app_plug` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_admiappplug_adm_ix` (`adminpresetapplyid`)
...
--
-- Dumping data for table `obd_adminpresets_app_plug`
--

LOCK TABLES `obd_adminpresets_app_plug` WRITE;
/*!40000 ALTER TABLE `obd_adminpresets_app_plug` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_adminpresets_app_plug` ENABLE KEYS */;
UNLOCK TABLES;
