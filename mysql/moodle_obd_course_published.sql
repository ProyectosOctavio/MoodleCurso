...
--
-- Table structure for table `obd_course_published`
--

DROP TABLE IF EXISTS `obd_course_published`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_course_published` (
...
--
-- Dumping data for table `obd_course_published`
--

LOCK TABLES `obd_course_published` WRITE;
/*!40000 ALTER TABLE `obd_course_published` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_course_published` ENABLE KEYS */;
UNLOCK TABLES;
