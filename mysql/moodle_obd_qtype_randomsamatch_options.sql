...
--
-- Table structure for table `obd_qtype_randomsamatch_options`
--

DROP TABLE IF EXISTS `obd_qtype_randomsamatch_options`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_qtype_randomsamatch_options` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `obd_qtyprandopti_que_uix` (`questionid`)
...
--
-- Dumping data for table `obd_qtype_randomsamatch_options`
--

LOCK TABLES `obd_qtype_randomsamatch_options` WRITE;
/*!40000 ALTER TABLE `obd_qtype_randomsamatch_options` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_qtype_randomsamatch_options` ENABLE KEYS */;
UNLOCK TABLES;
