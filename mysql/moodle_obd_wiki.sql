...
--
-- Table structure for table `obd_wiki`
--

DROP TABLE IF EXISTS `obd_wiki`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_wiki` (
...
--
-- Dumping data for table `obd_wiki`
--

LOCK TABLES `obd_wiki` WRITE;
/*!40000 ALTER TABLE `obd_wiki` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_wiki` ENABLE KEYS */;
UNLOCK TABLES;
