...
--
-- Table structure for table `obd_badge_external`
--

DROP TABLE IF EXISTS `obd_badge_external`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_badge_external` (
  ...
  PRIMARY KEY (`id`),
  KEY `obd_badgexte_bac_ix` (`backpackid`)
...
--
-- Dumping data for table `obd_badge_external`
--

LOCK TABLES `obd_badge_external` WRITE;
/*!40000 ALTER TABLE `obd_badge_external` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_badge_external` ENABLE KEYS */;
UNLOCK TABLES;
