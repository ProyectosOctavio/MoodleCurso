...
--
-- Table structure for table `obd_competency_framework`
--

DROP TABLE IF EXISTS `obd_competency_framework`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `obd_competency_framework` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `obd_compfram_idn_uix` (`idnumber`)
...
--
-- Dumping data for table `obd_competency_framework`
--

LOCK TABLES `obd_competency_framework` WRITE;
/*!40000 ALTER TABLE `obd_competency_framework` DISABLE KEYS */;
/*!40000 ALTER TABLE `obd_competency_framework` ENABLE KEYS */;
UNLOCK TABLES;
